...
import * as ɵngcc3 from './table.component';
...
function DataTableHeader_div_9_div_4_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵelementStart(1, "label");
    ɵngcc0.ɵɵelementStart(2, "input", 16);
    ɵngcc0.ɵɵlistener("ngModelChange", function DataTableHeader_div_9_div_4_Template_input_ngModelChange_2_listener($event) { var column_r14 = ctx.$implicit; return column_r14.visible = $event; });
    ɵngcc0.ɵɵelementEnd();
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(DataTableHeader, [{
    ...
    }], function () { return [{ type: ɵngcc3.DataTable, decorators: [{
                type: Inject,
